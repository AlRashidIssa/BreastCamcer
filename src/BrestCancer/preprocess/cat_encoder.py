    ...
    def call(self, 
        ...
        try:
            ...
            if replce:
                ...
                preprocess_info("Values replaced according to the provided dictionary.")
            else:
                ...
                if method == "label":
                    ...
                    preprocess_info("Label encoding applied.")
                elif method == "onehot":
                    ...
                    preprocess_info("One-hot encoding applied.")
                else:
                    preprocess_error(f"Unknown encoding method: {method}")
